 ...
 * miss and carries the way out. Ochre on ink rather than the usual warning
 * yellow, because it still has to belong to the design.
 */
export function DraftModeBanner() {
  return (
    <div className="sticky top-0 z-50 flex flex-wrap items-baseline justify-between gap-x-8 gap-y-1 bg-ink px-8 py-2.5 font-meta text-[0.7rem] tracking-[0.14em] text-paper uppercase">
      <p>
        <span className="text-ochre">Previewing drafts</span> — not what the
        public sees
      </p>
